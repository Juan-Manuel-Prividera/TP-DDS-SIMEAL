...
//
    ...
    TarjetaColaborador tarjetaColaboradorA = new TarjetaColaborador((Colaborador) ServiceLocator
      .getRepository(Repositorio.class).buscarPorId(137L, Colaborador.class),LocalDate.now());
    ServiceLocator.getRepository(TarjetaColaboradorRepository.class).guardar(tarjetaColaboradorA);
//
